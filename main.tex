...
Monitoring aquatic life is fundamental for understanding ecosystem health, guiding conservation efforts, and managing invaluable natural resources. Traditional surveys, including direct visual counts, quadrat survey diving, baited remote underwater video (BRUV), acoustic-trawling, netting, and trapping, have long served as the backbone of aquatic monitoring. While these methods provide valuable data, they often present logistical challenges, resource limitations, and potential disturbance to sensitive aquatic communities.

Recent advances in environmental DNA (eDNA) techniques have revolutionized biodiversity assessment by detecting organisms through the genetic material they shed into their surroundings (REF). Water-based eDNA surveys have consistently demonstrated remarkable efficacy in species detection and abundance quantification. These approaches have proven particularly valuable for monitoring endangered species (REF), detecting invasive organisms at early stages of colonization (REF), assessing community composition (REF), and quantitative assessments (Guri; Shelton; a couple of other studies) of species inference complementary to traditional surveys. The current advancements have further enhanced the precision of aquatic eDNA analysis shedding light in technical replicability, laboratory protocols, amplification bias, and bioinformatic pipelines substantially improving detection sensitivity and taxonomic resolution (REF). 

Concurrently, research on airborne eDNA has advanced significantly, demonstrating that genetic material from terrestrial organisms can be effectively captured through both active and passive air filtration methods. Pioneering studies by Clare et al. and Johnson et al. have established that air filtration can recover detectable concentrations of genetic material from terrestrial vertebrates and invertebrates. This emerging field has shown particular promise in biodiversity hotspots and enclosed environments where air circulation patterns facilitate DNA accumulation

Despite these parallel advances in aquatic and airborne eDNA research, no indication on weather free-genetic material is cross-medium transferable (i.e., from water to air). While several studies have reported 'unexpected' detection of aquatic organisms in air-based eDNA samples, these findings have typically been dismissed as laboratory contamination or attributed to secondary vectors such as animal feed in the zoo (REF). The systematic investigation of whether -- and to what extent -- genetic material naturally transfers from airborne to aerial environments remains conspicuously absent from the scientific literature.

This knowledge gap invites a fundamental rethinking of how genetic ecological signals propagate across environmental boundaries. Physically, environmental systems are inherently interconnected (through processes such as evaporation, precipitation, and other hydrological cycling), and theoretically biological material should not be confined to a single medium. Such ideological re-framing is based on the hypothesis that natural environmental processes such as evaporation, aerosolization, and splashing can transfer DNA molecules from aquatic habitats into the surrounding air, effectively turning the atmosphere into a diluted - yet informative - extension of the water column. 

Here, we present the first targeted investigation of cross-medium eDNA transfer, specifically examining whether genetic material from aquatic organisms can be detected in air samples collected above water surfaces. We selected a salmon spawning stream -- salmon species being known for their vigorous spawning behavior including leaping and jumping, serving as an ideal test case -- and measured coho salmon \textit{Oncorhynchus kisutch} eDNA concentration in water and air (passively) alongside visual counts over a 6 weeks during peak migration period. To rigorously evaluate this concept, we deployed four distinct air collection methods: passive air filters constructed from gelatin (commonly used in low-flow air filtration systems), polytetrafluoroethylene (PTFE; standard in high-flow air applications), and mixed cellulose ester (MCE; traditionally employed for water filtration), as well as an open container of deionized water exposed to ambient conditions (REF); chosen for their distinct physical properties and hypothesized affinities for settling DNA particles. This comprehensive comparison enables the assessment of both the detection sensitivity and the quantitative capacity of each method inferring population biological activities.

Our findings provide the first quantitative evidence of genetic material transferability from water to air, demonstrating that aquatic life signatures can be detected in atmospheric samples and quantified in ways that reflect actual population dynamics. This cross-medium detection and quantification represents not merely a technical advancement but a conceptual leap in ecological monitoring. Quantifying the genetic material transferability between mediums could present promising complementary insights for investigating microbial life transfer from aquatic to aerial environments (such as the order of magnitude of cross-medium transferability). Additionally, airborne eDNA signals offer low-impact, scalable extension of aquatic biomonitoring into the air, potentially yielding additional information without needing direct contact with water. Moreover, in environments where direct water sampling is hazardous or impractical--such as steep waterfalls or stagnant waters with microbial health risks -- airborne eDNA may represent the only viable means of assessing biological activity (REF). The resulting approach offers substantial advantages in safety, and scalability, opening a new frontier for non-invasive, real-time biomonitoring. Although the study focuses on salmon, the broader potential of this framework extends to a wide range of aquatic organisms. The findings not only can simplify field operations by reducing logistical demands and operational risks but more importantly reveal that ecological signals are not confined to water bodies. Rather, the air can serve as an additional, quantifiable reservoir of biodiversity data
