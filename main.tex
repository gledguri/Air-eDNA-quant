...
%All air filters collected roughly the same order of magnitude eDNA concentration when corrected for the surface area deployed (effort) indicating that air eDNA concentration is about e$^{-10.21}$ lower than that of water eDNA concentration. Despite all filters estimating roughly the same ballpark factor of dilution from water eDNA, small differences were observed (Figure \ref{fig:fig2} xxxxx). The results show that when correcting for the surface area, PTFE captured more eDNA 0.683 order of magnitude more than the average eDNA from all the air filters where the second best capturing method was the deionized water (MCE DI water) with 0.259 order of magnitude more than the average eDNA. Additionally the gelatin and MCE (suspended in air) had a lower capturability efficiency relative to the other filters with 0.242 and 0.701 orders of magnitude less eDNA quantities. 
