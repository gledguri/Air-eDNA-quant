...
# saveRDS(stanMod_count,here('Data','Output model data','stanMod_count_10k_it_v6.rds'))
# saveRDS(stan_data,here('Data','Output model data','stan_data_10k_it_v6.rds'))

stan_post1 <- read_rds(here('Data','Output model data','stanMod_count_10k_it_v6.rds'))
stan_post2 <- read_rds(here('Data','Output model data','stanMod_count_v6.rds'))
stan_post3 <- read_rds('/Users/gledguri/Library/CloudStorage/OneDrive-UW/UW/QM-qPCR-joint_clone/data/Zenodo/Mock_mod_output.rds')
stan_post4 <- read_rds('/Users/gledguri/Library/CloudStorage/OneDrive-UW/UW/QM-qPCR-joint_clone/data/Zenodo/Joint_mod_output.rds')

stan_post <- stan_post1
stan_post <- stan_post2
stan_post <- stan_post3
stan_post <- stan_post4
